...
def save_useful_files():
    ...
    save_file('https://data.cityofchicago.org/api/views/ijzp-q8t2/rows.csv?' +
              'accessType=DOWNLOAD', '2001-_crime.csv')
...
def main():
    ...
    needed_files = ['sentence_length.csv', 'socio_econ.csv',
                    'Chicago_shape.zip', '2001-_crime.csv', 'population.csv']
