...
def generate_crime_socioecon_data(crime_data, geo_data,
    ...
    crime_socioecon_data = crime_arrest_rate.merge(socio_econ_data,
...
def geo_plot(geo_crime_socioecon_ca):
    ...
    '''
    geo_crime_socioecon_ca['crime_rate'] = geo_crime_socioecon_ca
    ['crime_rate'] * 100
...
def Question4(crime_data, geo_data, population_data, socio_econ_data):
    ...
    geo_crime_socioecon_data = \
        Question3.geopandas.GeoDataFrame(crime_socioecon_data,
                                         geometry='geometry')
